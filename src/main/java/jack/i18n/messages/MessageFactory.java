...
public class MessageFactory {
    ...
    /**
     * Zone to use when rendering messages.
     */
     ...
     *               If the value is {@code null}, {@link #DEFAULT_LOCALE default locale} is used.
     * @param zoneId Initial zone to use.
     *               If the value is {@code null}, {@link #DEFAULT_ZONE default zone} is used.
     */
    public MessageFactory(Locale locale, ZoneId zoneId) throws IllegalArgumentException {
    ...
    public static MessageFactory createDefault(Locale locale, ZoneId zoneId) throws IllegalArgumentException {
        MessageFactory factory = new MessageFactory(locale, zoneId);
    ...
    /**
     * @return Zone to use for rendering.
     */
     ...
     * Sets the zone.
     *
     * @param zoneId Zone to use for rendering.
    ...
    public Message compile(String message) throws IllegalArgumentException, StringFragmentsException {
        ...
        return new Message(this, messageConstructs);
    }
